...
Over time, Apple has changed the APIs used by `mas` to manage App Store apps, limiting its capabilities. Please sign in using the App Store app instead, or any other system app. Subsequent redownloads can be performed with `mas install`.
